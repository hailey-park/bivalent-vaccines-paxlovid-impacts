...
strat1 <- (39240000) - bivalent_count
strat2 <- (previously_vacc_count) - bivalent_count
strat3 <- unvaccinated_count
strat4 <- (primary_series_count - bivalent_count)
strat5 <- sum(over_65$cumulative_at_least_one_dose  - over_65$cumulative_bivalent_booster_recip_count) * prop_over_75
strat6 <- sum(over_65$cumulative_at_least_one_dose  - over_65$cumulative_bivalent_booster_recip_count)
strat7 <- sum(over_50$cumulative_at_least_one_dose  - over_50$cumulative_bivalent_booster_recip_count)
...
strat8 <- ((39240000 * prop_over_50) - sum(over_50$cumulative_fully_vaccinated)) 
strat9 <- ((39240000 * prop_over_65) - sum(over_65$cumulative_fully_vaccinated)) 
strat10 <- ((39240000 * prop_over_65) - (sum(over_65$cumulative_fully_vaccinated))) * prop_over_75 
strat11 <- (sum(over_50$cumulative_fully_vaccinated) - (sum(over_50$cumulative_booster_recip_count) - sum(over_50$cumulative_bivalent_booster_recip_count)))  - sum(over_50$cumulative_bivalent_booster_recip_count)#cumulative_booster_recip_count also includes bivalent counts
strat12 <- (sum(over_65$cumulative_fully_vaccinated) - (sum(over_65$cumulative_booster_recip_count) - sum(over_65$cumulative_bivalent_booster_recip_count)))  - sum(over_65$cumulative_bivalent_booster_recip_count)
strat13 <- ((sum(over_65$cumulative_fully_vaccinated) - (sum(over_65$cumulative_booster_recip_count) - sum(over_65$cumulative_bivalent_booster_recip_count)))  - sum(over_65$cumulative_bivalent_booster_recip_count)) * prop_over_75
strat14 <- sum(over_50$cumulative_booster_recip_count) - sum(over_50$cumulative_bivalent_booster_recip_count)
strat15 <- sum(over_65$cumulative_booster_recip_count) - sum(over_65$cumulative_bivalent_booster_recip_count)
strat16 <- (sum(over_65$cumulative_booster_recip_count) - sum(over_65$cumulative_bivalent_booster_recip_count)) * prop_over_75
...
write.csv(bivalent_booster_clean , 'outcome data clean/bivalent_booster_doses_clean_perfectuptake.csv')
