...
#######################################
#Strategies (Stratified Risk Groups)

#Strategy 7: Giving Paxlovid to those Unvaccinated (65+ years)
strat7 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("65-74 years", "75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Unvaccinated")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
...
strat8 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Unvaccinated")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
...
strat9 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("65-74 years", "75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Primary Series")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
...
strat10 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Primary Series")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
...
strat11 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("65-74 years", "75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Boosted (1 dose)", "Boosted (2 doses)")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
...
strat12 <- predictions_pax_df %>% mutate(averted_death_diff = ifelse((age_group %in% c("75-84 years", "85+ years") & boost_2_vax_status_match %in% c("Boosted (1 dose)", "Boosted (2 doses)")), predicted_death * pe_deaths * (max_pax_uptake - baseline_pax_uptake), 0),
